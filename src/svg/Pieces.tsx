/**
 * Short for "Tile Width", this value represents the SVG width in pixels of a single tile/square
 * of a board (or a single piece on a board) when at it's original, unscaled size.
 * 
 * Because SVG renders and scales dynamically, this value is used as a scale factor when handling
 * logic of converting the SVG graphics to the displayed pixels to the user.  It is also used during
 * user interaction with the board; for example, when determining where on the board the user clicked.
 * 
 * This value should always equal the original SVG width of a single tile/square, and shouldn't be 
 * updated unless the underlying SVG changes.
 */
export const TW = 45
